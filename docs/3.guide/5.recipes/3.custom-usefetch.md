...
::callout
Оборачивание в [`useAsyncData`](/docs/4.x/api/composables/use-async-data) **избегает двойной загрузки данных при серверном рендеринге** (сервер и клиент при гидрации).
::
