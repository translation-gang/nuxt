...
::important
Перед деплоем в продакшен добавьте эту переменную в окружение продакшена.
::
...
async function login() {
  ...
  .catch(() => alert('Неверные учётные данные'))
}
</script>

<template>
  <form @submit.prevent="login">
    <input v-model="credentials.email" type="email" placeholder="Эл. почта" />
