...
export default defineNuxtModule({
  ...
  moduleDependencies: {
    'some-module': {
      // Ограничение версии: при другой установленной Nuxt выдаст ошибку при старте
      version: '>=2',
...
Конфигурация модуля в рантайм приложения не попадает. Чтобы добавить код в приложение пользователя, используйте каталог **runtime**.
