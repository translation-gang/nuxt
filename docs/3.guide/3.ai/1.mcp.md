...
2. **Preferences: Open Workspace Settings (JSON)** — открыть JSON настроек рабочей области
...
1. Репозиторий → **Настройки** (Settings) → **Code & automation** → **Copilot** → **Coding agent**
2. В разделе **конфигурации MCP** (MCP configuration):
...
2. Дождитесь PR
3. В PR: **Просмотр сессии** (View session) → **…** → **Copilot** → шаг **Start MCP Servers**
