...
Многие композаблы и утилиты — как встроенные, так и пользовательские — могут получить доступ к экземпляру Nuxt. Его можно получить не везде в приложении, потому что при каждом запросе создается новый экземпляр.
