...
::note
Рекомендуем публиковать содержимое слоя как npm-пакет (публичный или приватный, например через [GitHub Packages](https://docs.github.com/en/packages/learn-github-packages/introduction-to-github-packages)), а не полагаться на удалённый слой.

Либо добавьте [удалённый git URL напрямую как зависимость](https://docs.npmjs.com/cli/v11/configuring-npm/package-json#git-urls-as-dependencies).
::
