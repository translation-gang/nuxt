...
:video-accordion{title="Посмотрите видео от Александра Лихтера об обработке асинхронного кода в композаблах и исправлении ошибки 'Nuxt instance is unavailable' в вашем приложении" videoId="ofuKRZLtOdY"}
