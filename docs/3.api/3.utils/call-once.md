...
::note
`callOnce` это композабл, предназначенная для непосредственного вызова в функции setup, плагине или маршрутном middleware, потому что она должна добавлять данные в полезную нагрузку Nuxt, чтобы избежать повторного вызова функции на стороне клиента при гидратации страницы.
::
