...
description: 'Одна из самых ценных ролей в open source — уделить время тому, чтобы полезно сообщить об ошибке.'
...
Сначала просмотрите [открытые задачи](https://github.com/nuxt/nuxt/issues) и [обсуждения](https://github.com/nuxt/nuxt/discussions) на GitHub. Если найдёте похожий баг, лучше дописать в существующую тему, чем создавать дубликат.
