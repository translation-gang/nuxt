---
title: "plugins"
description: "В Nuxt плагины подключают код при создании Vue-приложения: плагины Vue, хуки и другое."
head.title: "Каталог plugins/"
...
Вы можете использовать [композаблы](/docs/3.x/directory-structure/composables/), а также [утилиты](/docs/3.x/directory-structure/utils/) в плагинах Nuxt:
...
## Предоставление хелперов {#providing-helpers}
...
::important
По возможности предпочитайте [`композаблы`](/docs/3.x/directory-structure/composables/) вместо глобальных хелперов — так проще не засорять глобальное пространство имён и держать бандл компактнее.
::
