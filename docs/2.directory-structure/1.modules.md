...
Вам не нужно добавлять эти локальные модули в [`nuxt.config.ts`](/docs/3.x/directory-structure/nuxt-config/) по отдельности.
...
:read-more{to="/docs/3.x/guide/going-further/modules"}
