...
Если есть каталог [`pages/`](/docs/3.x/directory-structure/pages), для отображения текущей страницы нужен компонент [`<NuxtPage>`](/docs/3.x/api/components/nuxt-page):
