...
title: "layouts"
head.title: "layouts/"
description: "Nuxt даёт механизм layouts: общие каркасы интерфейса выносятся в переиспользуемые лейауты."
navigation.icon: i-lucide-folder
---

::tip{icon="i-lucide-rocket" }
Для производительности компоненты из этого каталога подгружаются лениво при использовании.
::
