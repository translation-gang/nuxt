...
Nuxt [автоматически генерирует](/docs/3.x/guide/concepts/typescript) файл `.nuxt/tsconfig.json` с разрешёнными алиасами путей и прочими настройками по умолчанию.
