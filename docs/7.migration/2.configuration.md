...
Существует ряд изменений, касающихся рекомендуемой передовой практики Vue, а также ряд изменений между Vue 2 и 3.
...
Создайте файл [плагина](/docs/guide/directory-structure/plugins), чтобы глобализировать ваш хранилище:
