---
title: 'Маршрутизация'
description: Маршрутизация файловой системы Nuxt создает маршрут для каждого файла в директории pages/.
...
Nuxt предоставляет настраиваемый фреймворк middleware маршрутов, который можно использовать во всем вашем приложении. Это идеально для извлечения кода, который вы хотите запускать перед переходом на определенный маршрут.
