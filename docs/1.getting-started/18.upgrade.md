...
::tip
Проверить возможность заранее: задать `future.compatibilityVersion: 5` (см. [Тестирование Nuxt 5](/docs/4.x/getting-started/upgrade#testing-nuxt-5)) или явно включить `experimental.viteEnvironmentApi: true`.
::
