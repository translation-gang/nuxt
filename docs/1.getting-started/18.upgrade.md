...
* `respectNoSSRHeader` реализуется на стороне проекта с помощью [серверного посредника (server middleware)](https://github.com/nuxt/nuxt/blob/c660b39447f0d5b8790c0826092638d321cd6821/packages/nuxt/src/core/runtime/nitro/no-ssr.ts#L8-L9)
