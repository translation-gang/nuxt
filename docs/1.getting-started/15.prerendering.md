...
В [контексте Nuxt](/docs/3.x/guide/going-further/nuxt-app#the-nuxt-context) в рантайме можно зарегистрировать дополнительные маршруты для пререндера Nitro.
