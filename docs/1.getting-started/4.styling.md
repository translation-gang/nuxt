...
You can refer to the [Vue docs](https://ru.vuejs.org/api/sfc-css-features.html) for a comprehensive reference about styling components in SFC.
...
Refer to the [Vue docs](https://ru.vuejs.org/guide/essentials/class-and-style.html) for more information.
