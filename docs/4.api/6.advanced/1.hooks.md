...
`link:prefetch`              | `to`                | Клиент        | Вызывается при prefetch для [`<NuxtLink>`](/docs/3.x/api/components/nuxt-link).
...
Полный список хуков см. в [исходниках схемы хуков](https://github.com/nuxt/nuxt/blob/main/packages/schema/src/types/hooks.ts#L83).
