---
title: "Шаблоны"
description: Утилиты Nuxt Kit для шаблонов и генерации дополнительных файлов в dev и при сборке.
links:
  - label: Исходники
...
Шаблоны создают дополнительные файлы в dev и при сборке: они попадают в виртуальную файловую систему и доступны в плагинах, лейаутах, компонентах и т. п. `addTemplate` и `addTypeTemplate` регистрируют шаблоны в приложении Nuxt; `updateTemplates` пересобирает шаблоны по фильтру (или все сразу).
