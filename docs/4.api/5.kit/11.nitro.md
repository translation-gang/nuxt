...
Регистрирует обработчик Nitro только в dev; в production-сборку не включается.
...
Иногда нужен обработчик только в dev — например просмотр конфигурации Tailwind.
