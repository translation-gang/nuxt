...
| -------------------- | ----------------------------------- | -------- | ---------------------------------------------------------------------------------------------------------------------------- |
| `cwd`                | `string`                            | `false`  | База для разрешения путей. По умолчанию — rootDir Nuxt.                                                                      |
| `alias`              | `Record<string, string>`{lang="ts"} | `false`  | Объект алиасов. По умолчанию — алиасы из конфигурации Nuxt.                                                                    |
| `extensions`         | `string[]`                          | `false`  | Расширения файлов для подстановки. По умолчанию — из конфигурации Nuxt.                                                           |
