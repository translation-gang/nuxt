...
::important
Композабл доступен в Nuxt v4.4.2+.
::

## Описание

Композабл для озвучивания программами чтения с экрана изменений динамического контента. В отличие от [`useRouteAnnouncer`](/docs/4.x/api/composables/use-route-announcer), который автоматически озвучивает смену маршрута, `useAnnouncer` даёт ручной контроль над тем, что и когда озвучивать.
