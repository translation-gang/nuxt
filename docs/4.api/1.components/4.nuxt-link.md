...
- `activeClass`: класс для активной ссылки. Аналог [Vue Router `linkActiveClass`](https://router.vuejs.org/api/interfaces/routeroptions#linkActiveClass-). По умолчанию `"router-link-active"`.
- `exactActiveClass`: класс для точного совпадения. Аналог [Vue Router `linkExactActiveClass`](https://router.vuejs.org/api/interfaces/routeroptions#linkExactActiveClass-). По умолчанию `"router-link-exact-active"`.
