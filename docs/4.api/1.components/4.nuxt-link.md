...
Чтобы включить предзагрузку с других источников, задайте в `nuxt.config` опцию `crossOriginPrefetch`. Будет использоваться [Speculation Rules API](https://developer.mozilla.org/en-US/docs/Web/API/Speculation_Rules_API).
