...
Включает относительное форматирование времени через API Intl.RelativeTimeFormat:
...
При `relative: true` доступны опции из [`Intl.RelativeTimeFormat`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/RelativeTimeFormat):
