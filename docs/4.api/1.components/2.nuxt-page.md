...
- `name`: указывает `<RouterView>` имя компонента из опции components совпавшего маршрута. See [Named Views](/docs/4.x/directory-structure/app/pages#named-views) for the `name@view.vue` filename convention.
  - тип: `string`
