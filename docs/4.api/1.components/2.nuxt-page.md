...
- `name`: указывает `<RouterView>` имя компонента из опции components совпавшего маршрута. См. [именованные представления](/docs/4.x/directory-structure/app/pages#named-views) и соглашение об именах файлов `name@view.vue`.
  - тип: `string`
