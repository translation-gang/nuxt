...
Расширение сгенерированного `.nuxt/tsconfig.node.json`.

**См.**: [tsconfig.json information](/docs/4.x/directory-structure/tsconfig)

### `sharedTsConfig`

Расширение сгенерированного `.nuxt/tsconfig.shared.json`.
...
Расширение сгенерированного `.nuxt/tsconfig.app.json`.
