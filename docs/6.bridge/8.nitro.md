---
title: Nitro
description: 'Включение Nitro в приложении Nuxt 2 через Nuxt Bridge.'
---
...
Nuxt 3 ввёл интерфейс командной строки [`nuxi`](/docs/3.x/api/commands/add). Обновите скрипты в `package.json`, чтобы использовать поддержку Nuxt Bridge:
