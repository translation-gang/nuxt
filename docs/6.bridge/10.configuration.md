---
title: Конфигурация
description: Флаги и опции Nuxt Bridge, перенос `router.base` и `build.publicPath` в формат Nuxt 3.
---
...
- [Миграция на Nuxt 3](/docs/migration/overview) — когда возможности Nuxt Bridge освоены
